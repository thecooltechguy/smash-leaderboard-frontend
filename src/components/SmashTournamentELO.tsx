...
export default function SmashTournamentELO({ defaultTab = "rankings" }: SmashTournamentELOProps) {
  ...
  const updateMatchesURL = (
    ...
    if (defaultTab === "matches") {
      ...
      characterFilter.forEach(character => params.append("character", character));
                                        ...
                                        {(() => {
                                          ...
                                          const isExactMatch =
                                            ...
                                            playerNames.every((name) =>
                                              selectedPlayerFilter.includes(name)
                                            ) &&
                                            selectedPlayerFilter.every((name) =>
                                          ...
                                          return (
                                            <button
                                              onClick={() => {
                                                ...
                                                setTimeout(async () => {
                                                  setMatchesPage(1);
                                                  updateMatchesURL(playerNames, [], is1v1);
                                                  await fetchMatches(
                                                    1,
                                                    false,
                                                    playerNames,
